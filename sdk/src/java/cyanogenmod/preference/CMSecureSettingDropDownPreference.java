...
public class CMSecureSettingDropDownPreference extends SelfRemovingDropDownPreference {
    public CMSecureSettingDropDownPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public CMSecureSettingDropDownPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
