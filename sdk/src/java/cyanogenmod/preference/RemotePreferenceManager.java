...
public class RemotePreferenceManager {
    ...
    private final Map<String, RemotePreference> mCallbacks = new ArrayMap<>();
    ...
    public void attach(String key, RemotePreference pref) {
        Intent i;
        synchronized (mCache) {
            i = mCache.get(key);
            ...
            if (i != null) {
                ...
                if (mCallbacks.size() == 1) {
                    ...
                    mContext.registerReceiver(mListener,
                            ...
                            Manifest.permission.MANAGE_PARTS, mHandler);
                }
                requestUpdate(key);
            }
        }
