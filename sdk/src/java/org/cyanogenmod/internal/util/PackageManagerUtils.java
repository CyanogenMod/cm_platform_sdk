...
public final class PackageManagerUtils {
    ...
    /**
     * Checks whether a given package is missing
     *
     * @param context
     * @param packageName
     * @return true if the package is missing
     */
    public static boolean isAppMissing(final Context context, final String packageName) {
