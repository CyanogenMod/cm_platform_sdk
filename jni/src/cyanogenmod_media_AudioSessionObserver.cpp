		...
		jint streams, jobject jSessions)
{
    ...
    if (status != NO_ERROR) {
        ...
        ALOGD("AudioSystem::listAudioSessions count=%d", sessions.size());
    }
...
{
    ALOGD("register_cyanogenmod_media_AudioSessionObserver");
    ...
    ALOGD("DONE WITH ARRAYLIST");
    jclass audioSessionInfoClass = FindClassOrDie(env, "cyanogenmod/media/AudioSessionObserver$AudioSessionInfo");
    ...
    ALOGD("DONE WITH INFO");
    gAudioSessionEventHandlerMethods.postAudioSessionEventFromNative =
            GetStaticMethodIDOrDie(env, env->FindClass(kClassPathName),
            "audioSessionCallbackFromNative", "(ILcyanogenmod/media/AudioSessionObserver$AudioSessionInfo;Z)V");
