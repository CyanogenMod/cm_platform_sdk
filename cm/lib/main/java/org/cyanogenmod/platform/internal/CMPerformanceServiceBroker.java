...
public class CMPerformanceServiceBroker extends
    ...
    private static final ComponentName TARGET_IMPLEMENTATION_COMPONENT =
            new ComponentName("org.cyanogenmod.cmperformance.service",
                    "org.cyanogenmod.cmperformance.service.CMPerformanceService");
...
//                    }
    ...
    private final class BinderService extends IPerformanceManagerProvider.Stub {
        @Override
...
//             getBrokeredService().onLowerPowerModeChanged(on);
        }
