 ...
 * @hide
 */
public class LiveLockScreenServiceBroker extends BrokerableCMSystemService<ILiveLockScreenManagerProvider> {
    ...
    private final class BinderService extends ILiveLockScreenManager.Stub {
        ...
        public void enqueueLiveLockScreen(String pkg, int id,
            ...
            ILiveLockScreenManagerProvider liveLockScreenManagerProvider =
                    getImplementingServiceGuarded();
