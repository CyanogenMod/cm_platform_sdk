...
public class OutdoorModeController extends LiveDisplayFeature {
    ...
    public synchronized void onSettingsChanged(Uri uri) {
        mAutoOutdoorMode = getInt(CMSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, 1) == 1;
        updateOutdoorMode();
    }
    ...
    void setAutomaticOutdoorModeEnabled(boolean enable) {
        setInt(CMSettings.System.DISPLAY_AUTO_OUTDOOR_MODE, (enable ? 1 : 0));
    }
