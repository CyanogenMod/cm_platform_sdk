...
public abstract class BrokerableCMSystemService<T extends IInterface> extends CMSystemService {
    ...
    private IInterface mImplementingBinderInterface;
    ...
    public <T extends IInterface> T getImplementingServiceGuarded() {
        final T service = (T)getOrConnectService();
        if (service != null) {
            return service;
        }
        return (T)getDefaultImplementation();
    }
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            synchronized (BrokerableCMSystemService.this) {
                try {
                    String localDescriptor = service.getInterfaceDescriptor();
                    IInterface localInterface = service.queryLocalInterface(localDescriptor);
                    mImplementingBinderInterface = localInterface;
