...
public class LiveLockScreenManagerService extends SystemService{
    ...
    private LiveLockScreen mCurrentLiveLockScreen;
    ...
    private void showInternalLocked(String pkg, int id, LiveLockScreen lls) {
    ...
    private void updateCurrentLiveLockScreenLocked() {
        ...
        LiveLockScreen currentLls = current != null ? current.lls : getDefaultLiveLockScreen();
    ...
    private LiveLockScreen getDefaultLiveLockScreen() {
        ComponentName cn = mLockPatternUtils.getThirdPartyKeyguardComponent();
        return cn != null ? new LiveLockScreen(cn, LiveLockScreen.PRIORITY_MIN) : null;
    }

    private IBinder mService = new ILiveLockScreenManager.Stub() {

        @Override
        public void show(String pkg, int id, LiveLockScreen lls)
    ...
    private static final class LiveLockScreenRecord implements Comparable<LiveLockScreenRecord> {
        ...
        public LiveLockScreenRecord(String pkg, int id, LiveLockScreen lls) {
            this.pkg = pkg;
            this.id = id;
            this.lls = lls;
