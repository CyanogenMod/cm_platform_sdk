...
public class CMHardwareServiceBroker extends
    ...
    private final IBinder mService = new ICMHardwareService.Stub() {
        ...
        public int getColorBalanceMin() throws RemoteException{
            checkPermission();
            return getBrokeredService().getColorBalanceMin();
        }

        @Override
        public int getColorBalanceMax() throws RemoteException {
            checkPermission();
            return getBrokeredService().getColorBalanceMax();
        }

        @Override
        public int getColorBalance() throws RemoteException {
            checkPermission();
            return getBrokeredService().getColorBalance();
        }

        @Override
        public boolean setColorBalance(int value)  throws RemoteException{
            checkPermission();
            return getBrokeredService().setColorBalance(value);
        }
        ...
        public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            ...
            try {
                ...
                pw.println("Supported features: " + getSupportedFeatures());
