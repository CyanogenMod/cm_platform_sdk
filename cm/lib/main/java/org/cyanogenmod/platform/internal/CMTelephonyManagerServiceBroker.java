...
import org.cyanogenmod.internal.telephony.ICMTelephonyManagerProvider;
...
public class CMTelephonyManagerServiceBroker extends
        BrokerableCMSystemService<ICMTelephonyManagerProvider> {
    ...
    private final ICMTelephonyManagerProvider mServiceStubForFailure =
            new ICMTelephonyManagerProvider.NoOp();
    ...
    public CMTelephonyManagerServiceBroker(Context context) {
        super(context);
        mContext = context;
    ...
    @Override
    protected ICMTelephonyManagerProvider getIBinderAsIInterface(@NonNull IBinder service) {
        return ICMTelephonyManagerProvider.Stub.asInterface(service);
    }

    @Override
    protected ICMTelephonyManagerProvider getDefaultImplementation() {
    ...
    private final class BinderService extends ICMTelephonyManagerProvider.Stub {
