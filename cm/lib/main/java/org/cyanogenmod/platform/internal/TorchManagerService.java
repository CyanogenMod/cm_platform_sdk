...
public class TorchManagerService extends SystemService {
    ...
    private void setNotificationShown(boolean show) {
        ...
        try {
            ...
            if (show) {
                nm.notify(R.string.flashlight_not_title, buildNotification());
            } else {
                nm.cancel(R.string.flashlight_not_title);
            }
        } finally {
    ...
    private Notification buildNotification() {
        ...
        return new Notification.Builder(mContext)
                .setContentTitle(mContext.getString(R.string.flashlight_not_title))
                .setContentText(mContext.getString(R.string.flashlight_not_summary))
                .setAutoCancel(false)
                .setOngoing(true)
    ...
    private void enforceCallingOrSelf() {
