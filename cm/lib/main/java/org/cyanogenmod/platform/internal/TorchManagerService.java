...
public class TorchManagerService extends SystemService {
    ...
    private void setNotificationShown(boolean show) {
        ...
        try {
            ...
            if (show) {
                nm.notify(org.cyanogenmod.platform.internal.R.string.flashlight_not_title,
                        buildNotification());
            } else {
                nm.cancel(org.cyanogenmod.platform.internal.R.string.flashlight_not_title);
            }
        } finally {
    ...
    private final IBinder mService = new ITorchService.Stub() {
        ...
        public synchronized void setTorchEnabled(boolean enabled) {
            mContext.enforceCallingOrSelfPermission(
                    cyanogenmod.platform.Manifest.permission.ACCESS_TORCH_SERVICE, null);
