...
public class TorchManagerService extends SystemService {

    private static final String TAG = TorchManagerService.class.getSimpleName();
    ...
    public TorchManagerService(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void onStart() {
        if (!mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH)) {
            Log.w(TAG, "Not initializing Torch manager because system does not have flash.");
            return;
        }
        ...
        publishBinderService(CMContextConstants.CM_TORCH_SERVICE, mService);
    }
    ...
    private void setNotificationShown(boolean show) {
        ...
        try {
            ...
            if (show) {
                nm.notify(org.cyanogenmod.platform.internal.R.string.quick_settings_tile_flashlight_not_title,
                        buildNotification());
            } else {
                nm.cancel(org.cyanogenmod.platform.internal.R.string.quick_settings_tile_flashlight_not_title);
            }
        } finally {
    ...
    private Notification buildNotification() {
        ...
        return new Notification.Builder(mContext)
                .setContentTitle(
                        mContext.getString(org.cyanogenmod.platform.internal.R.string.flashlight_not_title))
                .setContentText(
                        mContext.getString(org.cyanogenmod.platform.internal.R.string.flashlight_not_summary))
                .setAutoCancel(false)
                .setOngoing(true)
                .setVisibility(Notification.VISIBILITY_PUBLIC)
                .setSmallIcon(org.cyanogenmod.platform.internal.R.drawable.ic_signal_flashlight_disable)
    ...
    private final IBinder mService = new ITorchService.Stub() {
        ...
        public synchronized void setTorchEnabled(boolean enabled) {
            mContext.enforceCallingOrSelfPermission(
                    android.Manifest.permission.ACCESS_TORCH_SERVICE, null);
    ...
    private final CameraManager.AvailabilityCallback mAvailabilityCallback =
            new CameraManager.AvailabilityCallback() {
                ...
                private void setTorchAvailable(boolean available) {
                    ...
                    synchronized (TorchManagerService.this) {
