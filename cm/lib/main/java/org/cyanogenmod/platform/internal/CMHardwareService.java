...
public class CMHardwareService extends CMSystemService implements ThermalUpdateCallback {
    ...
    private interface CMHardwareInterface {
        ...
        public TouchscreenGesture isTouchscreenGestureEnabled(TouchscreenGesture gesture);
    ...
    private class LegacyCMHardware implements CMHardwareInterface {
        ...
        public isTouchscreenGestureEnabled(TouchscreenGesture gesture) {
            return TouchscreenGestures.isGestureEnabled(gesture);
        }

        public setTouchscreenGestureEnabled(TouchscreenGesture gesture, boolean state) {
    ...
    private final IBinder mService = new ICMHardwareService.Stub() {
        ...
        public boolean isTouchscreenGestureEnabled(TouchscreenGesture gesture) {
            ...
            return mCmHwImpl.isTouchscreenGestureEnabled();
        }
