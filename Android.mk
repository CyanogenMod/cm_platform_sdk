...
cyanogenmod_app_src := cm/java/cyanogenmod/app
internal_src := cm/java/org/cyanogenmod/internal
...
LOCAL_SRC_FILES := \
           ...
           $(call find-other-java-files, $(internal_src)) \
           $(call find-other-java-files, $(library_src))
...
## READ ME: ########################################################
LOCAL_SRC_FILES += \
           $(call all-aidl-files-under, $(cyanogemod_app_src))

# Include aidl files from cyanogenmod.app namespace as well as internal src aidl files
LOCAL_AIDL_INCLUDES += \
           $(call find-other-aidl-files, $(cyanogenmod_app_src))
...
LOCAL_SRC_FILES := \
            $(call find-other-java-files, $(cyanogenmod_app_src)) \
            $(call find-other-aidl-files, $(internal_src))
