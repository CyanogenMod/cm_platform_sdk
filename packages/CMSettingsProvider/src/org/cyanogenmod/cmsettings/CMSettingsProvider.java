...
public class CMSettingsProvider extends ContentProvider {
    ...
    public static final String WRITE_CM_SETTINGS = "cyanogenmod.permission.WRITE_SETTINGS";
    public static final String WRITE_CM_SECURE_SETTINGS = "cyanogenmod.permission.WRITE_SECURE_SETTINGS";
    ...
    static {
        sUriMatcher.addURI(CMSettings.AUTHORITY, CMDatabaseHelper.CMTableNames.TABLE_SYSTEM, SYSTEM);
        sUriMatcher.addURI(CMSettings.AUTHORITY, CMDatabaseHelper.CMTableNames.TABLE_SECURE, SECURE);
        sUriMatcher.addURI(CMSettings.AUTHORITY, CMDatabaseHelper.CMTableNames.TABLE_GLOBAL, GLOBAL);
     ...
     * instance of {@link CMDatabaseHelper} is created for the specified user and returned.
     * @param callingUser
     * @return
     */
