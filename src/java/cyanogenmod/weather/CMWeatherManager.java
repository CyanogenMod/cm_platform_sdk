...
public class CMWeatherManager {
    ...
    private final IWeatherServiceProviderChangeListener mProviderChangeListener =
        ...
        @Override
        public void onWeatherServiceProviderChanged(final ComponentName componenName) {
                ...
                public void run() {
                    synchronized (mProviderChangedListeners) {
                        ...
                        for (WeatherServiceProviderChangeListener listener
                            ...
                            try {
                                listener.onWeatherServiceProviderChanged(componenName);
                            } catch (Throwable e) {
    ...
    public interface WeatherServiceProviderChangeListener {
         ...
         *
         * @param componentName The component name of the weather service provider
         */
        void onWeatherServiceProviderChanged(ComponentName componentName);
    }
}
