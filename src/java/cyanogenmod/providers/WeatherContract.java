...
public class WeatherContract {
    ...
    public static class WeatherColumns {
        ...
        /**
         * A code identifying the current weather condition. NOTE: this value fully depends on the
         * implementation of the weather provider servide and can potentially change when you swith
         * providers
         * <P>Type: INTEGER</P>
         */
