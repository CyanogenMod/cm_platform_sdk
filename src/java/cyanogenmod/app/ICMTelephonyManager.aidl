...
interface ICMTelephonyManager {
    ...
    boolean isSimActive(int subId);
    boolean isDataConnectionSelectedOnSim(int subId);
    boolean isDataConnectionEnabled();

    // You need the MODIFY_MSIM_PHONE_STATE permission
    void setSimState(int subId, boolean active);
    void setDataConnectionSelectedOnSim(int subId);
    void setDataConnectionEnabled(boolean active);
    void setPhoneCallUsingSim(int subId);
    void setSmsUsingSim(int subId);
}
