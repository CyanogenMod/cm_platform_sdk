...
public class TorchManager {
    ...
    public static synchronized TorchManager getInstance(Context context) {
        if (sInstance == null) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.w(TAG, "error calling toggleTorch() on service", e);
                }
            }
        });
    }
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.w(TAG, "error calling setTorchEnabled() on service", e);
                }
            }
        });
    }
