...
abstract public class BaseLiveLockManagerService extends Service
    ...
    @Override
    abstract public void enqueueLiveLockScreen(String pkg, int id,
            LiveLockScreenInfo lls) throws RemoteException;

    @Override
    abstract public void cancelLiveLockScreen(String pkg, int id) throws RemoteException;
     ...
     */
    protected final void enforceSamePackageOrSystem(String pkg, LiveLockScreenInfo llsInfo) {
    ...
    private final IBinder mService = new ILiveLockScreenManagerProvider.Stub() {
        ...
        public void enqueueLiveLockScreen(String pkg, int id, LiveLockScreenInfo llsInfo)
            ...
            BaseLiveLockManagerService.this.enqueueLiveLockScreen(pkg, id, llsInfo);
        }

        @Override
        public void cancelLiveLockScreen(String pkg, int id) throws RemoteException {
            enforceAccessPermission();
            BaseLiveLockManagerService.this.cancelLiveLockScreen(pkg, id);
        }
