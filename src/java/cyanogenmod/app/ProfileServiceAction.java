...
public class ProfileServiceAction implements Parcelable {
    ...
    public static final Parcelable.Creator<ProfileServiceAction> CREATOR
            = new Parcelable.Creator<ProfileServiceAction>() {
        @Override
        public ProfileServiceAction createFromParcel(Parcel in) {
            return new ProfileServiceAction(in);
        }

        @Override
        public ProfileServiceAction[] newArray(int size) {
            return new ProfileServiceAction[size];
        }
    };
