...
public class ThemeManagerTest extends AndroidTestCase {
    ...
    public void testApplyDefaultTheme() {
        ...
        Log.d(TAG, "defaultThemePkg=" + defaultThemePkg + ", components=" + components);
    ...
    private static List<String> getSupportedComponentsForTheme(Context context, String themePkgName) {
